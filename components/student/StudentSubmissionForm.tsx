...
const compressImage = (file: File): Promise<Blob> => {
  return new Promise((resolve, reject) => {
    // Don't compress if it's already small enough or not an image.
...
export default function StudentSubmissionForm({ submissionInfo, onLogout }: StudentSubmissionFormProps) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const compressedPhotoBlob = await compressImage(studentPhotoFile!);
            const photoId = uuidv4();
            const photoRef = storage.ref(`student_photos/${submissionInfo.principalId}/${photoId}.jpg`);
            await photoRef.put(compressedPhotoBlob);
                ...
                <div className="space-y-8">
                     <div id="pdf-page-1">
                        <RegistrationFormPage1 
                            ...
                            studentPhoto={studentPhotoPreview} 
